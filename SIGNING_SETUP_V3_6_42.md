...
از نسخه v3.6.42، APK release باید با کلید دائمی شما امضا شود. اگر Secrets را تنظیم نکنید، GitHub Actions عمداً متوقف می‌شود تا اشتباهاً APK با امضای موقت ساخته نشود.
