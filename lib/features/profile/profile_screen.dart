...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('پروفایل و اطلاعات وکیل'), actions: const [GlobalSettingsButton()]),
            ...
            child: ListView(
              ...
              const Card(
                child: ListTile(
                  ...
                  title: Text('پروفایل و اطلاعات وکیل'),
                  subtitle: Text('نام کاربری، عنوان وکیل، شماره پروانه و کانون / مرکز فقط با اجازه خودت در متون حقوقی استفاده می‌شود.'),
                ),
              ),
              ...
              FilledButton.icon(
                onPressed: () async {
                  ...
                  if (!mounted) return;
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('پروفایل و اطلاعات وکیل ذخیره شد')));
                },
