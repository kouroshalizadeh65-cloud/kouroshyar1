...
class FinanceScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('مالی'), actions: const [GlobalSearchButton()]),
              ...
              Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                    ...
                    'مانده: ${toPersianDigits((income - expense).toStringAsFixed(0))} تومان',
                  ),
                ),
              ),
              ...
              for (final item in items)
                Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${item.type} | ${toPersianDigits(item.amount.toStringAsFixed(0))} تومان | ${item.category ?? 'بدون دسته'}\n'
